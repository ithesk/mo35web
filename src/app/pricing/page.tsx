      ...
      <div className="max-w-5xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="text-center mb-12">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 hover:border-[#25D366]/60 text-[#25D366] rounded-2xl font-medium transition-all"
          >
            ...
            {lang === 'es' ? 'Usar el Bot de WhatsApp' : 'Use the WhatsApp Bot'}
          </a>
