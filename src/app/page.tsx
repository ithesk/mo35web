        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
          ...
          <div className="text-left animate-slideUp" style={{ animationDelay: '0.1s' }}>
            ...
            <a
              ...
              className="mt-10 inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-2xl font-bold transition-all transform hover:scale-105 shadow-lg shadow-[#25D366]/30"
            >
