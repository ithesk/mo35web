...
import { Smartphone, Info, Lock, ArrowRight, Download, Check, X, ChevronRight, Apple } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
          ...
          <div className="text-left animate-slideUp" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-xl leading-relaxed">
              Descubre la potencia de nuestra nueva aplicación nativa. Más rápida, más segura y diseñada para profesionales.
            </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 hover:border-[#25D366]/60 text-[#25D366] rounded-2xl font-medium transition-all"
              >
                <WhatsAppIcon />
